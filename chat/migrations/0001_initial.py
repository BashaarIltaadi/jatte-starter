# Generated by Django 4.2.1 on 2024-08-29 12:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('waiting', 'Waiting'), ('closed', 'Closed')], default='waiting', max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
